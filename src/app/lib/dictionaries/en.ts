...
const en = {
  ...
  quests: {
    items: {
      addAvatar: { title: "Add avatar" },
      addBanner: { title: "Add banner" },
      writeBio: { title: "Write bio" },
      addFirstLink: { title: "Add first link" },
      addSpotify: { title: "Add Spotify" },
      addDiscord: { title: "Add Discord" },
      firstLike: { title: "Receive first like" },
      tenLikes: { title: "Receive 10 likes" },
      firstComment: { title: "Receive first comment" },
      fiveComments: { title: "Receive 5 comments" },
      oneHundredViews: { title: "Reach 100 views" },
      oneThousandViews: { title: "Reach 1000 views" },
      firstBadge: { title: "Unlock first badge" },
      rareBadge: { title: "Unlock rare badge" },
      legendaryBadge: { title: "Unlock legendary badge" },
    },
  },
  auraLevels: {
    E: {
  ...
  dashboard: {
    ...
    overview: {
      ...
      questProgressDescription:
        "Quest milestones turn your profile setup, social traction, and badge collection into permanent progression.",
      ...
      allAuraQuestsComplete: "All Aura quests complete",
