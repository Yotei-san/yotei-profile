...
const ptBR = {
  common: {
    ...
    questCompletion: "Conclusao de Quests",
    completed: "Concluido",
    remaining: "Restante",
    reward: "Recompensa",
    milestone: "Marco",
  ...
  quests: {
    items: {
      addAvatar: { title: "Adicionar avatar" },
      addBanner: { title: "Adicionar banner" },
      writeBio: { title: "Escrever bio" },
      addFirstLink: { title: "Adicionar primeiro link" },
      addSpotify: { title: "Adicionar Spotify" },
      addDiscord: { title: "Adicionar Discord" },
      firstLike: { title: "Receber primeiro like" },
      tenLikes: { title: "Receber 10 likes" },
      firstComment: { title: "Receber primeiro comentario" },
      fiveComments: { title: "Receber 5 comentarios" },
      oneHundredViews: { title: "Alcancar 100 views" },
      oneThousandViews: { title: "Alcancar 1000 views" },
      firstBadge: { title: "Desbloquear primeira badge" },
      rareBadge: { title: "Desbloquear badge rara" },
      legendaryBadge: { title: "Desbloquear badge lendaria" },
    },
  },
  auraLevels: {
    E: {
  ...
  dashboard: {
    ...
    overview: {
      ...
      questProgressDescription:
        "Milestones de quest transformam setup de perfil, tracao social e colecao de badges em progressao permanente.",
      ...
      allAuraQuestsComplete: "Todas as quests de Aura foram concluidas",
      allRewardsClaimed: "Todas as recompensas foram resgatadas",
      maxProgress: "Maximo",
