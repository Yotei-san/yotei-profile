...
export function getProfileMotionTokens(motionLevel: ProfileMotionLevel) {
  ...
  if (motionLevel === "alive") {
    return {
      ...
      badgeGlowBoost: 1.18,
      badgeHoverLiftPx: 2,
      badgeHoverScale: 1.028,
      badgeOrbitDriftPx: 1.6,
      badgeSheenDurationS: 5.6,
      hoverLiftPx: 3,
      hoverScale: 1.01,
      hoverShadowBoost: 1,
  ...
  return {
    ...
    badgeGlowBoost: 1.06,
    badgeHoverLiftPx: 1,
    badgeHoverScale: 1.014,
    badgeOrbitDriftPx: 0.9,
    badgeSheenDurationS: 6.6,
    hoverLiftPx: 1,
    hoverScale: 1.003,
