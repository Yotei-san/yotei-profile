...
const PROFILE_PRESET_DEFINITIONS: Record<ProfilePresetId, ProfilePresetDefinition> = {
  cinematic: {
    ...
    composition: {
      ...
      order: ["hero", "music", "links", "socials", "live", "badges", "stats"],
    },
    render: {
  ...
  ghost: {
    ...
    composition: {
      ...
      order: ["hero", "badges", "music", "links", "socials", "live", "stats"],
    },
    render: {
      shellVisibility: "ghost",
      moduleGapScale: 0.94,
  ...
  cyber: {
    ...
    composition: {
      ...
      order: ["hero", "music", "socials", "links", "live", "stats", "badges"],
    },
    render: {
      shellVisibility: "soft",
      moduleGapScale: 0.9,
  ...
  minimalist: {
    ...
    composition: {
      ...
      order: ["hero", "links", "music", "socials", "live", "badges", "stats"],
    },
    render: {
      shellVisibility: "ghost",
      moduleGapScale: 0.82,
  ...
  ambient: {
    ...
    composition: {
      ...
      order: ["hero", "links", "music", "socials", "badges", "live", "stats"],
    },
    render: {
      shellVisibility: "soft",
      moduleGapScale: 1.08,
  ...
  devcore: {
    ...
    composition: {
      ...
      order: ["hero", "links", "socials", "music", "live", "stats", "badges"],
    },
    render: {
      shellVisibility: "soft",
      moduleGapScale: 0.88,
  ...
  afterhours: {
    ...
    composition: {
      ...
      order: ["hero", "music", "links", "live", "socials", "badges", "stats"],
    },
    render: {
      shellVisibility: "ghost",
      moduleGapScale: 1.02,
  ...
  softglass: {
    ...
    composition: {
      ...
      order: ["hero", "music", "links", "socials", "badges", "stats", "live"],
    },
    render: {
      shellVisibility: "soft",
      moduleGapScale: 1.02,
